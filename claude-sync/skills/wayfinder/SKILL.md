---
name: wayfinder
description: Plan a chunk of work too big for one agent session as a shared map of decision tickets on the issue tracker, resolving them one at a time until the route is clear. Use when an idea is large and foggy and the user wants the way forward charted before anything is built. Not for work already specced or ticketed.
---
