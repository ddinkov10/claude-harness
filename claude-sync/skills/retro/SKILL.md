---
name: retro
description: "Conduct a retrospective on a coding session to improve the agent's environment for future runs. Use when the user asks for a retro, or wants better navigation, automated checks, coding standards, or tooling after a session. Not for reviewing code correctness or running the work itself."
---
