...
description: Turn a decision the user cannot answer alone into a Markdown questionnaire for someone else to fill in. Use when an open question depends on knowledge another person holds and the user wants it captured for async answering or a meeting. Not for questions the user can answer themselves.
---
