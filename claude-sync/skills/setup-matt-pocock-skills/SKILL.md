...
description: Configure a repo for these engineering skills — its issue tracker, triage label vocabulary, and domain doc layout. Use when a repo has not been set up yet, or when another skill reports that tracker or label configuration is missing. Run once per repo.
---
